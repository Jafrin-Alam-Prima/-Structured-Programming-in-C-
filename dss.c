...
/Suppose there is an array with any 10 elements. Now apply both binary and linear search and decide which mechanism is best for finding a specific element./
